...
### Changed 99 Interactions

#### alchemist - stonemason
You may overpay with Potions when buying Stonemason to gain two Alchemists.
*HAS BEEN CHANGED TO*
You may overpay with a Potion when buying Stonemason to gain two Alchemists.
#### apothecary - stonemason
You may overpay with Potions when buying Stonemason to gain two Apothecarys.
*HAS BEEN CHANGED TO*
You may overpay with a Potion when buying Stonemason to gain two Apothecarys.
#### band_of_misfits - feast
If you play Feast using Band of Misfits, it stays where it was, and *do* get the effect you would have gotten from trashing it.
If you play Feast using Band of Misfits, you can gain a Feast with it (despite Band of Misfits saying 'leaving it there', as this just refers to the card moving into play).
*HAS BEEN CHANGED TO*
If you play Feast using Band of Misfits, it stays where it was, and *do* get the effect you would have gotten from trashing it.
If you play Feast using Band of Misfits, you can gain a Feast with it (despite Band of Misfits saying 'leaving it there', as this just refers to the card moving into play).
#### captain - feast
If you play Feast using Captain, it stays where it was, and *do* get the effect you would have gotten from trashing it.
If you play Feast using Captain, you can gain a Feast with it (despite Captain saying 'leaving it there', as this just refers to the card moving into play).
*HAS BEEN CHANGED TO*
If you play Feast using Captain, it stays where it was, and *do* get the effect you would have gotten from trashing it.
If you play Feast using Captain, you can gain a Feast with it (despite Captain saying 'leaving it there', as this just refers to the card moving into play).
...
After having played a Guildmaster, when you gain a card, you can immediately use the Favors from that gain to play it using City-State.
#### daimyo - royal_galley
If you play Daimyo and then Royal Galley, which you use to play another Daimyo from your hand, since the next non-Command card you replay is the Royal Galley, it is replayed one more time afterwards by the second Daimyo.
If you play Duration card (such as Royal Galley) multiple times using a Daimyo that you set aside using Royal Galley, since the Daimyo is not in play, you will only get the Duration's this-turn effect multiple times, whereas you get the next-turn effect only once. If you set aside cards by playing Royal Galley using the Daimyo that you've set aside on the first Royal Galley, only the first set-aside card will be played again at the start of the next turn, while the rest will stay set-aside until the end of the game (but still count towards your deck).
*HAS BEEN CHANGED TO*
If you play Daimyo and then Royal Galley, which you use to play another Daimyo from your hand, since the next non-Command card you replay is the Royal Galley, it is replayed one more time afterwards by the second Daimyo.
If you play Duration card (such as Royal Galley) multiple times using a Daimyo that you set aside using Royal Galley, since the Daimyo is not in play, you will only get the Duration's this-turn effect multiple times, whereas you get the next-turn effect only once. If you set aside cards by playing Royal Galley using the Daimyo that you've set aside on the first Royal Galley, only the first set-aside card will be played again at the start of the next turn, while the rest will stay set-aside until the end of the game (but still count towards your deck).
...
*HAS BEEN CHANGED TO*
You may overpay with a Potion when buying Stonemason to gain two Familiars.
#### feast - overlord
If you play Feast using Overlord and try to trash itself, it stays where it was, and *do* get the effect.
If you play Feast using Overlord, you can gain a Feast with it (despite Overlord saying 'leaving it there', as this just refers to the card moving into play).
*HAS BEEN CHANGED TO*
If you play Feast using Overlord and try to trash itself, it stays where it was, and *do* get the effect.
If you play Feast using Overlord, you can gain a Feast with it (despite Overlord saying 'leaving it there', as this just refers to the card moving into play).
#### ferry - peasant
...
If you play Garrison or Stronghold using Way of the Chameleon, remember that Way of the Chameleon only affects stuff happening *this turn*, so on your next turn, you will get the normal bonus from Garrison or Stronghold.
*HAS BEEN CHANGED TO*
If you play Tent using Way of the Chameleon, you may still topdeck it when you discard it from play.
If you play Garrison or Stronghold using Way of the Chameleon, remember that Way of the Chameleon only affects stuff happening *this turn*, so on your next turn, you will get the normal bonus from Garrison or Stronghold.
#### galleria - innovation
...
*HAS BEEN CHANGED TO*
You may overpay with a Potion when buying Stonemason to gain two Golems.
...
Also, Harbor Village will not give you +$1 if you play a card as Way of the Chameleon that would give you +$ but no +Cards.
#### highwayman - reckless
[Only if Reckless is on a Treasure] If Reckless is on a Treasure and you are under Highwayman attack when you play said Treasure, you cannot return it to its pile, and it will be discarded normally during Clean-up.
...
*HAS BEEN CHANGED TO*
You may overpay with a Potion when buying Stonemason to gain two Possessions.
...
However, you get to choose whether to play the Riverboat card itself as Way of the Chameleon or normally when you play it on your next turn.
*HAS BEEN CHANGED TO*
If you play Riverboat using Way of the Chameleon, remember that Way of the Chameleon only affects stuff happening *this turn*, so on your next turn, you will get the normal bonus from Riverboat.
However, you get to choose whether to play the Riverboat card itself as Way of the Chameleon or normally when you play it on your next turn.
...
*HAS BEEN CHANGED TO*
You may overpay with a Potion when buying Stonemason to gain two Scrying Pools.
...
*HAS BEEN CHANGED TO*
You may overpay with a Potion when buying Stonemason to gain two Universitys.
